 ...
 */
package org.mifos.core.base.designsystem.theme
...
import org.mifos.core.base.designsystem.core.ComponentDsl
import org.mifos.core.base.designsystem.core.KptColorScheme
import org.mifos.core.base.designsystem.core.KptElevation
import org.mifos.core.base.designsystem.core.KptShapes
import org.mifos.core.base.designsystem.core.KptSpacing
import org.mifos.core.base.designsystem.core.KptThemeProvider
import org.mifos.core.base.designsystem.core.KptTypography

@Immutable
data class KptColorSchemeImpl(
    override val primary: Color = Color(0xFF3A608F),
    override val onPrimary: Color = Color(0xFFFFFFFF),
    override val primaryContainer: Color = Color(0xFFD3E3FF),
    override val onPrimaryContainer: Color = Color(0xFF1F4876),
    override val secondary: Color = Color(0xFF545F70),
    override val onSecondary: Color = Color(0xFFFFFFFF),
    override val secondaryContainer: Color = Color(0xFFD8E3F8),
    override val onSecondaryContainer: Color = Color(0xFF3C4758),
    override val tertiary: Color = Color(0xFF6D5677),
    override val onTertiary: Color = Color(0xFFFFFFFF),
    override val tertiaryContainer: Color = Color(0xFFF5D9FF),
    override val onTertiaryContainer: Color = Color(0xFF543F5E),
    ...
    override val background: Color = Color(0xFFF8F9FF),
    override val onBackground: Color = Color(0xFF191C20),
    override val surface: Color = Color(0xFFF8F9FF),
    override val onSurface: Color = Color(0xFF191C20),
    override val surfaceVariant: Color = Color(0xFFDFE2EB),
    override val onSurfaceVariant: Color = Color(0xFF43474E),
    override val outline: Color = Color(0xFF73777F),
    override val outlineVariant: Color = Color(0xFFC3C6CF),
    override val scrim: Color = Color(0xFF000000),
    override val inverseSurface: Color = Color(0xFF2E3035),
    override val inverseOnSurface: Color = Color(0xFFEFF0F7),
    override val inversePrimary: Color = Color(0xFFA4C9FE),
    override val surfaceDim: Color = Color(0xFFD9DAE0),
    override val surfaceBright: Color = Color(0xFFF8F9FF),
    override val surfaceContainerLowest: Color = Color(0xFFFFFFFF),
    override val surfaceContainerLow: Color = Color(0xFFF2F3FA),
    override val surfaceContainer: Color = Color(0xFFEDEDF4),
    override val surfaceContainerHigh: Color = Color(0xFFE7E8EE),
    override val surfaceContainerHighest: Color = Color(0xFFE1E2E9),
    override val surfaceTint: Color = Color(0xFF3A608F),
    override val primaryFixed: Color = Color(0xFFD3E3FF),
    override val primaryFixedDim: Color = Color(0xFFA4C9FE),
    override val onPrimaryFixed: Color = Color(0xFF001B3C),
    override val onPrimaryFixedVariant: Color = Color(0xFF1F4876),
    override val secondaryFixed: Color = Color(0xFFD8E3F8),
    override val secondaryFixedDim: Color = Color(0xFFBCC7DB),
    override val onSecondaryFixed: Color = Color(0xFF101B2B),
    override val onSecondaryFixedVariant: Color = Color(0xFF3C4758),
    override val tertiaryFixed: Color = Color(0xFFF5D9FF),
    override val tertiaryFixedDim: Color = Color(0xFFD9BDE3),
    override val onTertiaryFixed: Color = Color(0xFF281431),
    override val onTertiaryFixedVariant: Color = Color(0xFF543F5E),
) : KptColorScheme
...
class KptColorSchemeBuilder {
    ...
    var primaryContainer: Color = Color(0xFFD3E3FF)
    var onPrimaryContainer: Color = Color(0xFF1F4876)
    var secondary: Color = Color(0xFF545F70)
    var onSecondary: Color = Color(0xFFFFFFFF)
    var secondaryContainer: Color = Color(0xFFD8E3F8)
    var onSecondaryContainer: Color = Color(0xFF3C4758)
    var tertiary: Color = Color(0xFF6D5677)
    var onTertiary: Color = Color(0xFFFFFFFF)
    var tertiaryContainer: Color = Color(0xFFF5D9FF)
    var onTertiaryContainer: Color = Color(0xFF543F5E)
    ...
    var background: Color = Color(0xFFF8F9FF)
    var onBackground: Color = Color(0xFF191C20)
    var surface: Color = Color(0xFFF8F9FF)
    var onSurface: Color = Color(0xFF191C20)
    var surfaceVariant: Color = Color(0xFFDFE2EB)
    var onSurfaceVariant: Color = Color(0xFF43474E)
    var outline: Color = Color(0xFF73777F)
    var outlineVariant: Color = Color(0xFFC3C6CF)
