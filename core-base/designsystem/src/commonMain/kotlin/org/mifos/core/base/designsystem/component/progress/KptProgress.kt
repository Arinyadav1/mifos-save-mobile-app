...
sealed interface KptProgress {
    ...
    /**
     * Single shimmer bar (delegates to [mifos.core.base.designsystem.component.KptShimmerLoadingBox]).
     ...
     * [mifos.core.base.designsystem.component.KptShimmerListItem]). Use for list-screen
     * loading states.
     *
