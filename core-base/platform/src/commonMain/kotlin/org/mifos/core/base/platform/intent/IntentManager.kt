 ...
 */
package org.mifos.core.base.platform.intent
...
import org.mifos.core.base.platform.model.MimeType
...
interface IntentManager {
    ...
    suspend fun shareFile(fileUri: String, mimeType: org.mifos.core.base.platform.model.MimeType)

    /** Shares a file URI with the given MIME type and accompanying text. */
    suspend fun shareFile(fileUri: String, mimeType: org.mifos.core.base.platform.model.MimeType, extraText: String)
