 ...
 */
package org.mifos.core.base.ui.paging
...
class LoadMoreFooterCopyTest {
    ...
    fun offlineException_showsNoInternet() {
        val copy =
            loadMoreFooterCopy(OfflineException())
    ...
    fun networkShapedIOException_showsNoInternet() {
        ...
        val copy =
            loadMoreFooterCopy(FakeIOException("connection lost"))
        assertEquals("No internet", copy.label)
    }
    ...
    fun authError_showsSessionExpired() {
        val copy =
            loadMoreFooterCopy(RuntimeException("HTTP 401: Unauthorized"))
    ...
    fun serverError_showsServerUnavailable() {
        val copy =
            loadMoreFooterCopy(RuntimeException("HTTP 503: Service Unavailable"))
    ...
    fun unknownError_showsGenericFailedToLoadMore() {
        val copy =
            loadMoreFooterCopy(IllegalStateException("something weird"))
