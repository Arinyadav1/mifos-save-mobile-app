 ...
 */
package org.mifos.core.base.ui.util
...
actual object ShareUtils {
    ...
    actual fun sendEmail(to: String, subject: String?, body: String?) {
        ...
        subject?.let { q.add("subject=" + URLEncoder.encode(it, Charsets.UTF_8)) }
        body?.let { q.add("body=" + URLEncoder.encode(it, Charsets.UTF_8)) }
    ...
    actual fun sendViaSMS(number: String, message: String) {
        val encodedMessage = URLEncoder.encode(message, Charsets.UTF_8)
