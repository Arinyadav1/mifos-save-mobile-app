 ...
 */
package org.mifos.core.base.common
...
@Deprecated(
    ...
    replaceWith = ReplaceWith("ScreenState", "kpt.core.base.store.screen.ScreenState"),
)
...
@Deprecated(
    ...
    replaceWith = ReplaceWith(
        ...
        "kpt.core.base.store.screen.asLocalScreenStream",
    ),
)
