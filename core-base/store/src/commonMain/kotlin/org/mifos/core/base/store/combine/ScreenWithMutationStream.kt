 ...
 * [org.mifos.core.base.store.combine.CombinedState] flow. The read pipeline still uses [asScreenStream] /
...
interface ScreenWithMutationStream<R, W> {
     ...
     */
    val state: StateFlow<org.mifos.core.base.store.combine.CombinedState<R, W>>

    /**
     * Trigger a network refresh of the read pipeline. No-op if read-policy is
     * [org.mifos.core.base.store.screen.FetchPolicy.CACHE_ONLY]. Mirrors
     * [org.mifos.core.base.store.screen.ScreenDataStream.refresh].
     */
    fun refresh()
     ...
     * [org.mifos.core.base.store.submit.SubmitHandler], surfacing progress and
     * outcome in [org.mifos.core.base.store.combine.CombinedState.mutation].
     *
     * Idempotent — additional calls while a submission is in flight are dropped
     * silently (the underlying [org.mifos.core.base.store.submit.SubmitHandler]
     * enforces this).
     */
    fun submit(payload: W)

    /**
     * Cancel an in-flight submission and return [org.mifos.core.base.store.combine.CombinedState.mutation] to
     * [org.mifos.core.base.store.submit.SubmitState.Idle]. Called by screens
