 ...
 *
 * Wired into [org.mifos.core.base.store.infra.StoreFactory.createMutableStore] as an optional parameter so
 ...
 * and write back the resolved value. The [org.mifos.core.base.store.infra.StoreFactory] parameter is therefore
