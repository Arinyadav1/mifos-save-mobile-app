 ...
 */
package org.mifos.core.analytics.di
 ...
 *
 * ## Why this exists alongside [org.mifos.core.base.analytics.di.analyticsModule]?
 *
 ...
 * ```
 *
 * **(d) Use the [org.mifos.core.base.analytics.StubAnalyticsHelper] for debug builds:**
 * ```kotlin
 ...
 * ```
 *
 * @see AnalyticsHelper Contract being bound
 * @see NoOpAnalyticsHelper Default toolkit implementation
 * @see org.mifos.core.base.analytics.di.analyticsModule Framework-level expect/actual variant
 */
