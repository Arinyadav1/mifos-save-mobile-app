 ...
 * @return [org.mifos.core.model.emi.EmiResult] with monthly EMI, total payment, and total interest
 */
fun calculateEmi(principal: Double, annualRatePercent: Double, tenureMonths: Int): org.mifos.core.model.emi.EmiResult {
