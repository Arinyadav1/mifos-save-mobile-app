 ...
 * [mifos.core.base.store.submit.OfflineSubmitSyncer] retries it through the
 * same block.
 */
interface AlertsRepository {

    /** Reactive list of server-committed alerts, newest first. */
    fun alertsStream(): Flow<List<org.mifos.core.model.alerts.PriceAlert>>
     ...
     */
    suspend fun submitAlert(alert: org.mifos.core.model.alerts.PriceAlert): org.mifos.core.model.alerts.PriceAlert
