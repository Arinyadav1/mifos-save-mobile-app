...
interface MacroIndicatorsRepository {
    ...
    fun macroIndicatorStream(
        key: org.mifos.core.store.economic.impl.MacroIndicatorKey,
        scope: CoroutineScope,
    ): ScreenDataStream<org.mifos.core.model.economic.MacroIndicator>
     ...
     */
    fun macroIndicatorStream(
        keyFlow: Flow<org.mifos.core.store.economic.impl.MacroIndicatorKey>,
        scope: CoroutineScope,
    ): ScreenDataStream<org.mifos.core.model.economic.MacroIndicator>
}
