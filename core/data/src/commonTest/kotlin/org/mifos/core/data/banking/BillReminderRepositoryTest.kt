...
class BillReminderRepositoryTest {
    ...
    fun observeUpcomingWindowWrapsAcrossMonthBoundary() = runTest {
        ...
        assertTrue("june-end" contains upcoming, "30 should be in window from day 15 +20")
        assertTrue("july-3" contains upcoming, "3 should be in window after wrap")
        assertTrue("out-of-window" contains upcoming, "8 is past +20 from 15")
    }
