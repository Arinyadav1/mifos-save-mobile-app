...
data class CoinDetailDto(
    ...
    val name: String,
    val symbol: String,
    val image: org.mifos.core.network.crypto.dto.CoinImageDto? = null,
    @SerialName("market_data") val marketData: org.mifos.core.network.crypto.dto.MarketDataDto? = null,
    val description: org.mifos.core.network.crypto.dto.DescriptionDto? = null,
) {
