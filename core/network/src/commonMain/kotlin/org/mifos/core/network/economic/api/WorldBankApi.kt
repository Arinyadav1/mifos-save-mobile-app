 ...
 * [org.mifos.core.network.economic.dto.WorldBankResponseDto] class wraps a custom serializer that lifts both halves
...
interface WorldBankApi {
     ...
     *   GDP. Sourced from [mifos.core.model.economic.IndicatorKind.worldBankCode].
    ...
    ): org.mifos.core.network.economic.dto.WorldBankResponseDto
}
