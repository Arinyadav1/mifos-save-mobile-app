...
interface FrankfurterApi {
    ...
    @GET("v1/latest")
    suspend fun getLatestRates(@Query("from") from: String): org.mifos.core.network.currency.dto.ExchangeRatesDto
    ...
    suspend fun getHistoricalRates(
        ...
        @Query("to") to: String,
    ): org.mifos.core.network.currency.dto.RateHistoryDto
}
