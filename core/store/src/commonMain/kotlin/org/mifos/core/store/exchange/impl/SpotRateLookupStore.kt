 ...
 */
package org.mifos.core.store.exchange.impl
 ...
 * is registered under [mifos.core.store.AppStoreRegistry.SpotRate] so that
 * consumers can apply a [mifos.core.base.store.screen.FetchPolicy.NETWORK_ONLY]
