...
/**
 * Marker singleton — its instantiation has the side effect of wiring [org.mifos.core.base.security.FieldEncryptor]
 ...
 *
 * Delegates platform-specific database construction to [org.mifos.core.database.di.platformModule], which each
 * source set (`androidMain`, `desktopMain`, `nativeMain`, `jsMain`, `wasmJsMain`)
 * implements using the appropriate [AppDatabaseFactory][mifos.core.base.database.AppDatabaseFactory]
 * and SQLite driver.
 */
