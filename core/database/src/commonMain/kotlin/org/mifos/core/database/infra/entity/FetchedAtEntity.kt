 ...
 * the framework's [mifos.core.base.store.FetchedAtRepository] convention
 * (`<feature>:<storeName>[:<key>]`).
 *
 * Backs the framework's [mifos.core.base.store.FetchedAtRepository] interface
 * via [mifos.core.data.repositoryImpl.RoomFetchedAtRepository]. The framework
