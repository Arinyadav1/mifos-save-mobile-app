 ...
 *
 * Consumed by [mifos.core.data.store.RoomSubmitOutbox]. The framework uses this table to
...
interface DraftDao {
     ...
     * Call on app start via [mifos.core.store.infra.StoreCacheManager.pruneExpiredDrafts].
     */
    @Query(
