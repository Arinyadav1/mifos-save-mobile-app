 ...
 *
 * Supports optional field-level encryption via [org.mifos.core.base.security.FieldEncryptor]. When an encryptor
 ...
 *
 * Room 3 KMP instantiates converters via no-arg constructor. The [org.mifos.core.base.security.FieldEncryptor]
...
class ChargeTypeConverters {
    ...
    companion object {
        ...
        /**
         * Install a [org.mifos.core.base.security.FieldEncryptor] for all converter instances.
