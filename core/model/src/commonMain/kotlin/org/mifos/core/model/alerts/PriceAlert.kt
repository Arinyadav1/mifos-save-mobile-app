 ...
 *
 * Serializable because [mifos.core.data.alerts.AlertsRepository] persists
...
data class PriceAlert(
    val id: String,
    val coinId: String,
    val direction: org.mifos.core.model.alerts.AlertDirection,
...
enum class AlertDirection {
    /** Trigger when price rises above [org.mifos.core.model.alerts.PriceAlert.targetValue]. */
    ABOVE,

    /** Trigger when price falls below [org.mifos.core.model.alerts.PriceAlert.targetValue]. */
    BELOW,

    /** Trigger on a percent-change of at least [org.mifos.core.model.alerts.PriceAlert.targetValue]% over 24h. */
    PCT_CHANGE,
}
